local function apply_disable_default_koreader_menu_sections()
    ...
    local function is_enabled()
        ...
        return type(features) == "table" and features.disable_default_koreader_menu_sections == true
    end
...
return apply_disable_default_koreader_menu_sections
